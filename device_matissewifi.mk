...
#    device/samsung/matissewifi/gps/etc/flp.conf:system/etc/flp.conf \
#    device/samsung/matissewifi/gps/etc/izat.conf:system/etc/izat.conf \
#    device/samsung/matissewifi/gps/etc/sap.conf:system/etc/sap.conf \
#    device/samsung/matissewifi/gps/etc/quipc.conf:system/etc/quipc.conf \
#    device/samsung/matissewifi/gps/etc/xtra_root_cert.pem:system/etc/xtra_root_cert.pem \
#    device/samsung/matissewifi/gps/etc/xtwifi.conf:system/etc/xtwifi.conf
